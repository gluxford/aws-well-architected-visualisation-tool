// API endpoint - loaded from runtime-config.json via config-loader.js
const API_ENDPOINT = window.WA_CONFIG ? window.WA_CONFIG.apiEndpoint : (window.WA_API_ENDPOINT || '');
