...
function processRawWorkloadData(workloadData, lensReview) {
    ...
    const processedData = {
        ...
        owner: workloadData.Workload.Owner || 'N/A',
...
function displayWorkloadData(data) {
    ...
    document.getElementById('reviewer-name').textContent = data.owner || 'N/A';
    document.getElementById('account-id').textContent = data.accountIds ? data.accountIds.join(', ') : 'N/A';
    document.getElementById('region-display').textContent = data.regions ? data.regions.join(', ') : 'N/A';
