...
const COGNITO_CONFIG = {
    UserPoolId: 'ap-southeast-2_w4yn3NVXv',
    ClientId: '26ppdkveskrbuo78o95ebh065d',
        ...
        <div style="background: white; padding: 30px; border-radius: 8px; max-width: 400px; width: 90%;">
            ...
            <div id="signup-form" style="display: none;">
                ...
                <form id="register-form" style="margin-bottom: 15px;">
                    <div style="margin-bottom: 15px;">
                        <label style="display: block; margin-bottom: 5px;">Email (@cevo.com.au only):</label>
...
function handleSignUp(e) {
    ...
    if (!email.endsWith('@cevo.com.au')) {
        showAuthMessage('Only cevo.com.au email addresses are allowed', 'error');
        return;
    }
