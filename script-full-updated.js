...
function processRawWorkloadData(workloadData, lensReview) {
    ...
    if (workloadData.Workload && workloadData.Workload.Owner) {
        reviewerName = workloadData.Workload.Owner;
    }
...
function displayWorkloadData(data) {
    ...
    try {
        ...
        document.getElementById('reviewer-name').textContent = data.reviewerName || 'N/A';
        ...
        console.log("Reviewer name set to:", data.reviewerName);
